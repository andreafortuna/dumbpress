...
$config['LicenseName'] = getOption("ckfinderlicensename");
$config['LicenseKey'] = getOption("ckfinderlicensekey");
...
$baseDir = resolveUrl($baseUrl);
//
//$baseDir = "/Applications/XAMPP/xamppfiles/htdocs/dapensionelucrezia.it/uploads/";
/*
 * ### Advanced Settings
 */
